...
class ListIndex extends React.Component<IProps> {
  ...
  static async getInitialProps(context) {
    ...
    return { dataList,navList,title:context.query.title}
  }
  ...
  render() {
    return (
      <div className='container-fluid'>
        <Head>
          <title>迷途导航-{this.props.title}</title>
          {/* <title>迷途导航</title> */}
...
export default withRouter(ListIndex as any);
